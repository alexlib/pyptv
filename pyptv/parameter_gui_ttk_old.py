...
class MainParamsWindow(BaseParamWindow):
    ...
    def load_values(self):
        ...
        self.widgets['mask_flag']['var'].set(bool(pft_params.get('mask_flag', False)))
        self.widgets['existing_target']['var'].set(bool(pft_params.get('existing_target', False)))
        self.widgets['mask_base_name']['var'].set(str(pft_params.get('mask_base_name', '')))
        
        # Sequence parameters
        seq_params = params.get('sequence', {})
        self.widgets['seq_first']['var'].set(str(seq_params.get('first', 0)))
        self.widgets['seq_last']['var'].set(str(seq_params.get('last', 0)))
        ...
        self.widgets['xmin']['var'].set(str(vol_params.get('xmin', -100)))
        self.widgets['xmax']['var'].set(str(vol_params.get('xmax', 100)))
        self.widgets['zmin1']['var'].set(str(vol_params.get('zmin1', -100)))
        self.widgets['zmin2']['var'].set(str(vol_params.get('zmin2', -100)))
        
        # Criteria parameters
        crit_params = params.get('criteria', {})
        self.widgets['cnx']['var'].set(str(crit_params.get('cnx', 0.5)))
        self.widgets['cny']['var'].set(str(crit_params.get('cny', 0.5)))
        self.widgets['cn']['var'].set(str(crit_params.get('cn', 0.5)))
        self.widgets['csumg']['var'].set(str(crit_params.get('csumg', 0)))
        self.widgets['corrmin']['var'].set(str(crit_params.get('corrmin', 0.5)))
        self.widgets['eps0']['var'].set(str(crit_params.get('eps0', 0.1)))
