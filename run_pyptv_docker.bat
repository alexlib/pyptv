...
echo Verifying Python and Git installation...
...
docker exec -it pyptv-container bash -c "cd /home/ubuntu && git clone https://github.com/alexlib/pyptv.git && cd pyptv && python3 -m pip install -e ."

echo Creating desktop shortcut...
docker exec -it pyptv-container bash -c "echo '[Desktop Entry]\nVersion=1.0\nType=Application\nName=PyPTV\nComment=Particle Tracking Velocimetry\nExec=python3 -m pyptv.pyptv_gui\nIcon=\nPath=/home/ubuntu/work\nTerminal=false\nStartupNotify=false' > /home/ubuntu/Desktop/pyptv.desktop && chmod +x /home/ubuntu/Desktop/pyptv.desktop"

echo Creating startup script...
docker exec -it pyptv-container bash -c "echo '#!/bin/bash\ncd /home/ubuntu/work\npython3 -m pyptv.pyptv_gui' > /home/ubuntu/start_pyptv.sh && chmod +x /home/ubuntu/start_pyptv.sh"

echo PyPTV installation complete!
