...
echo.
echo Your local 'data' directory is mounted to /home/gui/work inside the container.
echo Any files you save there will be accessible on your host system.
echo.
echo To stop the container, run: docker-compose -f docker-compose.tiredofit.yml down
echo.
